    ...
    function createBaseTables() public payable onlyOwner {
        ...
        challengeCheckpointsTableId = _tableland.createTable(
            ...
            SQLHelpers.toCreateFromSchema(
                ...
                "id integer primary key not null, challengeId integer not null, ordering integer not null, title text not null, iconUrl text not null, iconId integer, lat real not null, lng real not null, creationTimestamp integer not null, isUserInputRequired integer, userInputAnswer text"
            )
        );
